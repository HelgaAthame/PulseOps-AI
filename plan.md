...
- ⬜ **Пагинация на `/events`** (сейчас показываются последние 50 без
  пагинации) — постранично или «Load more» + серверная выборка со сдвигом
- ⬜ **Overview: график MRR и live-лента одинаковой высоты** — сейчас панели
  в одной grid-строке, но контент разной высоты; сделать равными и красиво
  (проверить в браузере в обеих темах)
